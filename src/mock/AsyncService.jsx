const productos = [
    ...
    { id: 4, nombre: "Invictus", precio: 400, img: "https://i.postimg.cc/MKhT3Yhk/invictus.webp", descripcion: "Una fragancia fresca y deportiva que evoca la victoria y la fuerza.", stock: 10, categoria: "home"},
